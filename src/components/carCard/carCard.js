...
export default function CarCard({car = {}}) {
    ...
    const {
        ...
        status = "", type = "", doors = "", price_per_day = "",
        sale_price = "", media = [],
    } = car;
            ...
            <div id="carCard">
                <div className={`carCard ${flipped ? "isFlipped" : ""}`}>
                    <div className="cardFront">
                        ...
                        <div className="carImage">
                            {media.length > 0 ? (
                                <div className="carousel">
                                    <img 
                                        key={imgIndex}
                                        src={`http://localhost:3500/uploads/${media[imgIndex].image_path}`}
                                        alt={model}
                        ...
                        <div className="flip">
                            <div className="flipLink"
                                 onClick={() => setFlipped(true)}>Details</div>
                            <div className="price">
                                {type === "RENTAL"
                    ...
                    <div className="cardBack">
                        ...
                        <div className="details">
                            ...
                            <div className="detail">
                                <div className="detailLabel">
                                    <svg viewBox="0 0 17 16" fill="currentColor" stroke="currentColor" strokeWidth="0.3">
                            ...
                            <div className="detail">
                                <div className="detailLabel">
                                    <span className="colorCircle" style={{
