...
const steps = [
  {
    n: '01',
    title: 'Zgjedh',
    desc: 'Filtro sipas kategorisë, datës dhe buxhetit. Shiko çmimin final menjëherë.',
  },
  {
    n: '02',
    title: 'Konfirmo',
    desc: 'Rezervo online brenda 3 minutave. Konfirmim automatik me email.',
  },
  {
    n: '03',
    title: 'Merr',
    desc: 'Dorëzim në adresën tënde ose marrje nga pika jonë. Orari yt, rregullat tona.',
  },
  {
    n: '04',
    title: 'Udhëto',
    desc: 'Makina e pastër, tanku i plotë, asistencë aktive. Fokusohu vetëm rrugës.',
  },
];
      ...
      <div id="abPage" ref={ref}>
        <section className="abHero">
          ...
          <div className="abHeroLeft anim">
            ...
            <p className="abHeroP">
              Ndërtuam këtë platformë për të eliminuar konfuzionin, kostot e fshehura dhe burokacinë
              nga qiraja e makinave. Çdo vendim teknik, çdo politikë çmimi, çdo detaj i procesit —
        ...
        <section className="abStory">
          ...
          <div className="abStoryBody">
            <h2 className="abStoryH2 anim">
              Nga një ide e thjeshtë
              <br />
              deri tek platforma
            </h2>
            <div className="abStoryText anim">
              <p>
                Gjithçka filloi kur vumë re se tregu i qirasë së makinave ishte i mbushur me çmime
                të paqarta, procese të ngadalta dhe shërbim të dobët pas-shitjes. Vendosëm të
                ndërtojmë diçka ndryshe — një sistem ku klienti ka kontroll të plotë.
              </p>
              <p>
                Sot kemi mbi 500 makina, mijëra klientë të kënaqur dhe një ekip që beson se çdo
                udhëtim meriton të fillojë mirë.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="abDual">
          <div className="abDualCard abDualCardRental anim">
            ...
            <h3 className="abDualH3">
              Makina me qira,
              <br />
              kushte të qarta
            </h3>
            <p className="abDualP">
              Ditore, javore ose mujore — flotë moderne me çmime transparente, dorëzim në derë dhe
              asistencë 24/7 gjatë gjithë periudhës.
            </p>
          ...
          <div className="abDualCard abDualCardSale anim">
            ...
            <p className="abDualP">
              Dëshiron të shesësh makinën? Ne vlerësojmë falas dhe blejmë brenda 24 orësh. Dëshiron
              të blesh? Çdo makinë e inspektuar dhe me çmim real.
            </p>
            <ul className="abDualList">
