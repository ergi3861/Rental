...
export default function Home() {
  ...
  const locations = ['Tirana Airport', 'Tirana Center', 'Durres Port', 'Vlore Downtown'];
  ...
  const carTypes = [
    ...
    },
    {
      ...
      name: 'Kompakt',
      description:
        'Balancë mes komoditetit dhe madhësisë, e përshtatshme për udhëtime të shkurtra.',
      priceFrom: 6,
      people: '5',
      luggage: '3',
      doors: '4–5',
    ...
    <div id="home">
        ...
        <div className="rentalWidget">
          <div className="rentalWidgetContainer">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="rentalButton">
                Kerko makinat
              </button>
            </form>
          </div>
        ...
        <div className="tradeWrapper">
          <div className="tradeContent">
            ...
            <div className="tradeActions">
              <button onClick={() => (window.location.href = 'Sales')} className="buttonSale">
                Shiko makinat ne shitje
              </button>
              <button onClick={() => (window.location.href = 'Buy')} className="buttonBuy">
                Vlereso dhe shit makinen tende
              </button>
            </div>
          </div>
      ...
      <section className="howItWorksSection">
        ...
        <div className="howContent">
          ...
          <div className="feature">
            ...
            <p>
              Zgjidh nga nje game e larmishme markash dhe modelesh — SUV, sedan, hibride dhe me
              shume.
            </p>
          </div>
      ...
      <section className="infoSection">
        <div className="infoCard left">
          <div className="infoContent">
            ...
            <p>
              Ketu do te gjeni pergjigje per pyetjet me te shpeshta mbi tema te ndryshme, per te
              marre makinen me qera pa shqetesime dhe per te shijuar udhetimin tuaj me qetesi te
              plote.
            </p>

            <button onClick={() => (window.location.href = 'Faq')} className="faqBtn">
              Zbulo me shume:
            </button>
          </div>
        </div>
        ...
        <div className="infoCard right">
          <div className="infoContent">
            ...
            <p>
              Na ndiqni ne rrjetet tona sociale per te qendruar gjithmone te perditesuar mbi
              ofertat, promovimet dhe lajmet me te fundit.
            </p>
      ...
      <section className="values">
        <div className="value">
          <h3>PERFITUESE</h3>
          <p>
            Kush tha qe duhet te paguash me shume per te marre me shume? Ne e dime qe nje klient i
            kenaqur eshte deshmia me e mire. Prandaj synojme t'ju ofrojme saktesisht ate qe ju
            nevojitet: sherbim cilesor me cmimin e duhur
          </p>
        ...
        <div className="value">
          ...
          <p>
            Cdo udhetim eshte i ndryshem dhe cdo klient ka nevoja specifike. Zgjidhjet tona jane
            fleksibel: se bashku percaktojme makinen dhe sherbimet qe ju lejojne te perfitoni
            maksimumin nga pervoja juaj me ne.
          </p>
        ...
        <div className="value">
          <h3>E BESUESHME</h3>
          <p>
            Mund te na besoni plotesisht. Ju udhezojme dhe keshillojme ne zgjedhjen e makines dhe
            sherbimeve. Sqarojme kushtet dhe garantojme asistence 7 dite ne jave, gjate dhe pas
            qirase.
          </p>
      ...
      <section className="contactSection">
        <div className="contactContent">
          ...
          <p>
            Vendimet e keqija nuk vijne nga zgjedhje te gabuara por nga pyetje qe nuk u bene kurre.
            Nese ke dhe nje paqartesi te vetme, ndalo dhe sqaroje tani.
          </p>

          <button className="contactBtn" onClick={() => (window.location.href = 'Contact')}>
            Na kontakto
          </button>
