...
export default function Signup() {
  ...
  function updateStrength(v) {
    ...
    if (s <= 1)
      setStrength({ width: "25%", text: "Weak", color: "var(--danger)" });
    else if (s <= 3)
      setStrength({ width: "60%", text: "Medium", color: "var(--warning)" });
    else
      setStrength({ width: "100%", text: "Strong", color: "var(--success)" });
  }
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="form-grid">
            ...
            <div className="form-group full">
              ...
              <div id="strength-bar" style={{ width: strength.width, background: strength.color }}></div>
              <div id="strength-text">{strength.text}</div>
